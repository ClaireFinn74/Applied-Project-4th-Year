...
namespace _4thYearAppliedProject.SpeedLevels.FoalShadow
{
    ...
    /// </summary>
    public sealed partial class FoalShadowLvl4 : Page
    {

        public FoalShadowLvl4()
        {
            ...
            Image[] ImageArray = { Bear, Deer, FoalShadowHorse, Rhino, Wolf };
        ...
        public async void btnYes_Click(object sender, RoutedEventArgs e)
        {
            if (txtImgResult1.Text == txtImgResult2.Text)
            {
                ...
                Frame.Navigate(typeof(FoalShadowLvl5));
            }
