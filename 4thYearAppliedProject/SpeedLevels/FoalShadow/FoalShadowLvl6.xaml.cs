...
namespace _4thYearAppliedProject.SpeedLevels.FoalShadow
{
    ...
    /// </summary>
    public sealed partial class FoalShadowLvl6 : Page
    {
             
        public FoalShadowLvl6()
        {
            ...
            Image[] ImageArray = { Bear, Deer, BearFlipped, DeerFlipped };
        ...
        public async void btnYes_Click(object sender, RoutedEventArgs e)
        {
            if (txtImgResult1.Text == txtImgResult2.Text)
            {
                ...
                Frame.Navigate(typeof(FoalShadowLvl7));
            }
