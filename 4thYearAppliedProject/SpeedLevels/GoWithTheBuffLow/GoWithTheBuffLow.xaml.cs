...
using _4thYearAppliedProject.SpeedLevels.GoWithTheBuffLow;
using System;
...
namespace AppliedProject4thYear.SpeedLevels.GoWithTheBuffLow
{
    ...
    public sealed partial class GoWithTheBuffLow : Page
    {
        ...
        public GoWithTheBuffLow()
        {
            ...
            {
                Frame.Navigate(typeof(GoWithTheBuffLow));
            }
        }
        ...
        private void btnCheck_Click(object sender, RoutedEventArgs e)
        {
            if (txtSide1.Text == txtSide2.Text)
            {
                ...
                dispatcherTimer.Stop();
                if (GlobalClassBuffLow.globalHighscore >= 50)
                {
                    Frame.Navigate(typeof(GoWithTheBuffLowLvl2));
                }
                else
                {
                    this.Frame.Navigate(typeof(GoWithTheBuffLow), null);
                }
            }
            else
            {
