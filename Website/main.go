...
<head>
	<meta charset="UTF-8">
	<title> Scores from Brainworks </title>
	<style>
table {
...
func scoresPage(res http.ResponseWriter, req *http.Request) {
	...
	req, err := http.NewRequest("GET", os.ExpandEnv("https://brainworkssqllite.azurewebsites.net/tables/TodoItem?%24select=score"), nil)
	if err != nil {
		log.Fatal(err)
	}
